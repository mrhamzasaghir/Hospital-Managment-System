...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <section class="otherpage-hero">
        <h2 class="text-center">Dr. Khalid Iqbal</h2>
        <h5 class="text-center bio-spec">Orthopedic Surgen &<br> Consultant</h5>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    ...
                    <div class="bio-spc">
                        <h5 class="text-center">MBBS ,MSc (Orthopedic Surgery), Ph.D (Ortho) , FRCS (Ed) , FRCS, Fellowship</h5>
                    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-3">
                    <h2> BIO</h2>
                    <p>
                        Dr. khalid Iqbal practices through Sunrise Medical Hospital. Yasir has treated 328 patients<br>
                        <b> Qualification: </b>MBBS from King Edward Medical College Lahore, M.ch.(Ortho) from Liverpool University UK, FRCS from Royal College of Surgeons of Edinburgh, FRCS from Royal College of Surgeons of Glasgow, FICS from International College of Surgeon USA and Fellowship from Pakistan Academy of Medical Sciences<br>
                        <b>Experience:</b> 27 years of experience in this field.<br>
                        <b>Patient Satisfaction Score:</b> 99%<br>
                    </p>
                    <h3>Services of Dr. khalid Iqbal</h3>
                    <p>The Orthopedic Surgeon's, Dr. Khalid Iqbal, special areas of interest include:</p>
                    <ul>
                        <li>Back Relief</li>
                        <li>Knee Replacement</li>
                        <li>Spinal Surgeon</li>
                        <li>Limb Lengthening</li>
                        <li>Minimally Invasive Surgery</li>
                        <li>Arthroplasty- Hip Replacement</li>
                    </ul>
                    <h3>Diseases treated by Dr. Khalid Iqbal</h3>
                    <p>Diseases treated by Dr.  Khalid Iqbal include:</p>
                    <ul>
                        <li>Bone Cell Tumors</li>
                        <li>Disproportionate Limbs</li>
                        <li>Arthritis And Other Kinds Of Joint Pains, and among others</li>
                    </ul>
