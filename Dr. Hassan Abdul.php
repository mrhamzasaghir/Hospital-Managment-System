...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <section class="otherpage-hero">
        <h2 class="text-center">Dr. Hassan Abdul</h2>
        <h5 class="text-center bio-spec">Eye Surgeon<br> Eye Specialist</h5>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    ...
                    <div class="bio-spc">
                        <h5 class="text-center">Eye Surgeon, Eye Specialist<br>
MBBS, MCPS, FCPS (Ophth), FCPS (Vitreo-Retinal Surgery)</h5>
                    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-3">
                    <h2> BIO</h2>
                    <p>
                        Dr. Hassan Abdul practices through Sunrise Medical Hospital. Yasir has treated 283 patients<br>
                        <b> Qualification: </b>MBBS from Quaid-e-Azam University ,Islamabad, FCPS (Optha) from College of Physicians and Surgeons Pakistan, MCPS from College of Physicians and Surgeons Pakistan and FCPS (Vitreo-Retinal Surgery) from College of Physicians and Surgeons Pakistan<br>
                        <b>Experience:</b> 15 years of experience in this field.<br>
                        <b>Patient Satisfaction Score:</b> 98%<br>
                    </p>
                    <h3>Services of Dr. Hassan Abdul</h3>
                    <p>The Eyes Specialist, Dr. Hassan Abdul, special areas of interest include:</p>
                    <ul>
                        <li>Femto Lasik</li>
                        <li>Vitreo Retinal Surgery</li>
                        <li>Ophthamic Laser</li>
                        <li>Corneal Surgery</li>
                        <li>Canaloplasty</li>
                        <li>Refractive Surgery</li>
                    </ul>
                    <h3>Diseases treated by Dr. Hassan Abdul</h3>
                    <p>Diseases treated by Dr.  Hassan Abdul include:</p>
                    <ul>
                        <li>Chalazion</li>
                        <li>Arrhythmia</li>
                        <li>Eye Infection</li>
                        <li>Foreign Body In The Eyes</li>
                    </ul>
