...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <section class="otherpage-hero">
        <h2 class="text-center">Dr. Waleed Faraz</h2>
        <h5 class="text-center bio-spec">General Practitioner<br> General Surgery</h5>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    ...
                    <div class="bio-spc">
                        <h5 class="text-center">General Practitioner, Pulmonologist <br> MBBS</h5>
                    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-3">
                    <h2> BIO</h2>
                    <p>
                        Dr. Waleed Faraz practices through Sunrise Medical Hospital. Waleed has treated 137 patients<br>
                        <b> Qualification: </b>MBBS from Allama Iqbal Medical College, Lahore<br>
                        <b>Experience:</b> 3 years of experience in this field.<br>
                        <b>Patient Satisfaction Score:</b> 98%<br>
                    </p>
                    <h3>Services of Dr. Waleed Faraz</h3>
                    <p>The General Practitioner's, Dr. Waleed Faraz, special areas of interest include:</p>
                    <ul>
                        <li>Family Practice</li>
                        <li>General Surgery</li>
                        <li>Diabetes And Hypertension</li>
                        <li>Ordering Of Screening And Medical Tests</li>
                    </ul>
