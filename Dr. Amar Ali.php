...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <section class="otherpage-hero">
        <h2 class="text-center">Dr. Amar Ali</h2>
        <h5 class="text-center bio-spec">Neuro Psychiatrist, Psychiatrist,<br> Neurologist</h5>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    ...
                    <div class="bio-spc">
                        <h5 class="text-center">MBBS, FCPS(Psychiatry), <br>DCN(Neurology) Neuropsychiatrist</h5>
                    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-3">
                    <h2> BIO</h2>
                    <p>
                        Dr. Amar Ali practices through Sunrise Medical Hospital. Amar has treated 183 patients<br>
                        <b> Qualification: </b>MBBS from Bolan Medical College Quetta, FCPS(Psychiatry) from College Of Physician And Surgeons Pakistan and DCN(Neurology) from Jinnah Post Gradute Medical Center Karachi<br>
                        <b>Experience:</b> 10 years of experience in this field.<br>
                        <b>Patient Satisfaction Score:</b> 98%<br>
                    </p>
                    <h3>Services of Dr. Amar Ali</h3>
                    <p>The  Neuro Psychiatrist's, Dr. Amar Ali, special areas of interest include:</p>
                    <ul>
                        <li>Psychotherapy/li>
                        <li>Pharmacotherapy</li>
                        <li>Behavioral Therapy</li>
                        <li>Eeg (Electroencephalogram)</li>
                        <li>Motivation For Rehabilitation</li>
                    </ul>
                    <h3>Diseases treated by Dr. Amar Ali</h3>
                    <p>Diseases treated by Dr. Amar Ali include:</p>
                    <ul>
                        <li>Stroke</li>
                        <li>Parkinson's Disease</li>
                        <li>Alzheimer's Disease</li>
                        <li>Epilepsy, and among others</li>
                    </ul>
