...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <section class="otherpage-hero">
        <h2 class="text-center">Dr. Amina Aslam</h2>
        <h5 class="text-center bio-spec">Endocrinologist & <br>Diabetologist</h5>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    ...
                    <div class="bio-spc">
                        <h5 class="text-center"> MBBS | FCPS (Medicine) | Fellow in Endocrinology Diabetes and Metabolism</h5>
                    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-3">
                    <h2> BIO</h2>
                    <p>
                        Dr. Amina Aslam practices through Sunrise Medical Hospital. Yasir has treated 129 patients<br>
                        <b> Qualification: </b>MBBS from Baqai Medical University, Karachi and MSC (Diabetes and Endocrinology) from DOW University of Health Sciences, Karachi<br>
                        <b>Experience:</b> 3 years of experience in this field.<br>
                        <b>Patient Satisfaction Score:</b> 99%<br>
                    </p>
                    <h3>Services of Dr. Amina Aslam</h3>
                    <p>The endocrinologist's, Dr. Amina Aslam, special areas of interest include:</p>
                    <ul>
                        <li>Endocrinology</li>
                        <li>Weight Management</li>
                        <li>Diabetics and Complications</li>
                    </ul>
                    <h3>Diseases treated by Dr. Amina Aslam</h3>
                    <p>Diseases treated by Dr.  Amina Aslam include:</p>
                    <ul>
                        <li>Endocrine Disorders</li>
                        <li>Hypothyroidism</li>
                        <li>Diseases of Thyroid Glands</li>
                    </ul>
