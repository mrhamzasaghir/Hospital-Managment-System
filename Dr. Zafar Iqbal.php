...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="100">
    ...
    <section class="otherpage-hero">
        <h2 class="text-center">Dr.Zafar Iqbal</h2>
        <h5 class="text-center bio-spec">Specialist Otolaryngology(ENT)<br>Head & Neck Surgery Consultant</h5>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 mb-3">
                    ...
                    <div class="bio-spc">
                        <h5 class="text-center">Ent Specialist, Ent Surgeon <br> MBBS | FCPS (ENT)</h5>
                    </div>
                ...
                <div class="col-xl-8 col-lg-8 col-md-6 col-sm-12 mb-3">
                    <h2> BIO</h2>
                    <p>
                        Dr.Zafar Iqbal, is a specialist otolaryngology- Head & Neck surgery at Sunrise Medical
                        Hospital<br>
                        <b>Experience:</b> 12 years of experience in this field.<br>
                        <b>Patient Satisfaction Score:</b> 98%<br>
                    </p>
                    <h3>Services of Dr. Zafar Iqbal</h3>
                    <p>The Ent Surgeon's, Dr. Zafar Iqbal, special areas of interest include:</p>
                    <ul>
                        <li>Treatment For Nose Ailments</li>
                        <li>Rhinoplasty</li>
                        <li>Dizziness</li>
                    ...
                    <h3>Diseases treated by Dr. Zafar Iqbal</h3>
                    <p>Diseases treated by Dr. Zafar Iqbal include:</p>
                    <ul>
                        <li>Obstructive Sleep Apnea</li>
                        <li>Nasal Polyps</li>
                        <li>Dysphagia</li>
                        <li>Epistaxis</li>
                        <li>Influenza, and among others</li>
                    </ul>
